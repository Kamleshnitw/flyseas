(function ($) {
    ...
    /*------------------------------------
       ...
       // $('#mobile-menu-active').metisMenu();
        ...
        $(".hamburger-menus > a").on("click", function (e) {
            e.preventDefault();
            $(".slide-bars").toggleClass("show");
            $("body").addClass("on-side");
            $('.body-overlay').addClass('active');
            $(this).addClass('active');
        });

        $(".close-mobile-menus > a").on("click", function (e) {
            e.preventDefault();
            $(".slide-bars").removeClass("show");
            $("body").removeClass("on-side");
            $('.body-overlay').removeClass('active');
            $('.hamburger-menu > a').removeClass('active');
        });
        ...
        $('.body-overlay').on('click', function () {
            ...
            $(".slide-bars").removeClass("show");
            $("body").removeClass("on-side");
            $('.hamburger-menus > a').removeClass('active');
        });
    /* Search
        -------------------------------------------------------*/
...
$('.grid').imagesLoaded( function() {
    ...
    function myFunction(e) {
      var elems = document.querySelectorAll(".remve");
