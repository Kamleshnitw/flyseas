...
class ProductDescriptionResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $data['related_products'] = ProductResource::collection(VendorProduct::where('user_id', getVendor()->user_id)->where('category_id', $this->category_id)->orderBy('product_name','asc')->get());
